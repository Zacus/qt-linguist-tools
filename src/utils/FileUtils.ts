...
// 获取选中的翻译文件（支持多选和文件夹）
export async function getSelectedTranslationFiles(uri?: vscode.Uri, uris?: vscode.Uri[]): Promise<vscode.Uri[]> {
 ...
 * 验证文件是否存在且有效
 */
export async function validateFiles(files: vscode.Uri[]): Promise<vscode.Uri[]> {
